...
package io.github.monun.kommand.v1_19_3
...
class NMSKommandArgumentSupport : KommandArgumentSupport {
    ...
    override fun summonableEntity(): KommandArgument<NamespacedKey> {
        return ResourceArgument(commandBuildContext, Registries.ENTITY_TYPE) to SuggestionProviders.SUMMONABLE_ENTITIES provide { context, name ->
    ...
    override fun enchantment(): KommandArgument<Enchantment> {
        return ResourceArgument(commandBuildContext, Registries.ENCHANTMENT) provide { context, name ->
            val nms = ResourceArgument.getEnchantment(context, name).value()
    ...
    override fun mobEffect(): KommandArgument<PotionEffectType> {
        return ResourceArgument(commandBuildContext, Registries.MOB_EFFECT) provide { context, name ->
            val nms = ResourceArgument.getMobEffect(context, name).value()
